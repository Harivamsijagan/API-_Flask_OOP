...
# from  .choco_fudge  import user_bp
# app = Flask(__name__)
...
database = [
    {"email": "jaggupaturi9@gmail.com", "password": 987654321},
    {"email": "choco2@gmail.com", "password": 9912668999},
]


app.config["JWT_SECRET_KEY"] = "chocofudge"
jwt = JWTManager(app)
